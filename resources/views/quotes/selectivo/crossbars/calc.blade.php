        ...
        <div class="row m-3">
            <div  class="row bg-white p-4 shadow-lg rounded-lg">
                <div class="col-sm-4 col-xs-12">
                    <h2><i class="fa-solid fa-puzzle-piece"></i>&nbsp;Crossbars</h2>
                ...
                <div class="col-sm-8 col-xs-12">
                    <div class="form-group p-2 text-sm font-semibold table-responsive">
                        <table class="table">
                            ...
                            <tr>
                                <td class="text-left font-bold">Tipo: </td>
                                <td>{{$Piece->type}}</td>
                            </tr>
                            <tr>
                                <td class="text-left font-bold">Fondo: </td>
                                <td>{{$Piece->depth}}</td>
                            </tr>
                            <tr>
                    ...
                    <div class="form-group p-2 gap-2 flex items-center">
                        <a href="{{route('crossbars.show', $Quotation_Id)}}" class="btn btn-blue mb-2">
                            <i class="fa-solid fa-right-left fa-xl"></i>&nbsp; Corregir
                        </a>
                        <a href="{{route('crossbars.add_carrito', [$Quotation_Id,$Precio_sn_factor])}}" class="btn btn-black mb-2">
