                ...
                <div class="col-sm-4 col-xs-12">
                    <div class="form-group p-2 text-sm font-semibold table-responsive">
                        <table class="table">
                            ...
                            <tr>
                                <td colspan="2">Tornillos Trav-Diag: {{$TornTravDiag}}</td>
                            </tr>
                            <tr>
                                <td>Calzas: {{$Calzas}}</td>
                ...
                <div class="col-sm-4 col-xs-12">
                    <div class="form-group p-2 text-sm font-semibold table-responsive">
                        <table class="table">
                            ...
                            <tr>
                                <td colspan="3">Tot. Tor. Trav-Diag: {{$TotTornTravDiag}}</td>
                            </tr>
                            <tr class="text-right">
                    ...
                    <div class="form-group p-2 gap-2 flex items-center">
                        ...
                        <a href="{{route('shopping_cart.add_selectivo_marcos_estructurales', [$Quotation_Id,$Precio_sin_factor])}}" class="btn btn-black mb-2">
