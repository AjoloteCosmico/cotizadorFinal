            ...
            <div  class="row bg-white p-4 shadow-lg rounded-lg">
                ...
                <div class="col-sm-6 col-xs-12">
                    ...
                    <div class="form-group p-2 gap-2 flex items-center">
                        <a href="{{route('typeljoists.show', $Quotation_Id)}}" class="btn btn-blue mb-2">
                            <i class="fa-solid fa-right-left fa-xl"></i>&nbsp; Corregir
                        </a>
                        <a href="{{route('typeljoists.add_carrito', [$Quotation_Id,$Precio_sin_factor,'Clavija de Seguridad: $'.number_format($CostoTotalClavijas), 2)])}}" class="btn btn-black mb-2">
