        ...
        <div class="row m-3">
            <div  class="row bg-white p-4 shadow-lg rounded-lg">
                <div class="col-sm-6 col-xs-12">
                    <h2><i class="fa-solid fa-crop-simple"></i>&nbsp;Vigas Tipo L Calibre 14</h2>
                ...
                <div class="col-sm-6 col-xs-12">
                    ...
                    <div class="form-group p-2 gap-2 flex items-center">
                        <a href="{{route('typeljoists_caliber14.show', $Quotation_Id)}}" class="btn btn-blue mb-2">
                            <i class="fa-solid fa-right-left fa-xl"></i>&nbsp; Corregir
                        </a>
                        <a href="{{route('typeljoists_caliber14.add_carrito', [$Quotation_Id,$Precio_sin_factor,'Clavija de Seguridad: $'.number_format($CostoTotalClavijas, 2)])}}" class="btn btn-black mb-2">
