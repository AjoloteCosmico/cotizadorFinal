        ...
        <div class="row m-3">
            <div  class="row bg-white p-4 shadow-lg rounded-lg">
                <div class="col-sm-6 col-xs-12">
                    <h2><i class="fa-solid fa-crop-simple"></i>&nbsp;Vigas Tipo Estructural 14</h2>
                ...
                <div class="col-sm-6 col-xs-12">
                    <div class="form-group p-2 text-sm font-semibold table-responsive">
                        <table class="table">
                            ...
                            <tr class="text-right">
                                <td> Cantidad Tornillos: {{ $CantidadTornillos }}</td>
                                <td class="font-bold text-right text-1xl"> Costo Total Tornillos: ${{number_format($CostoTotalTornillos, 2)}}</td>
                            </tr>
                    ...
                    <div class="form-group p-2 gap-2 flex items-center">
                        <a href="{{route('typestrucruraljoists_caliber14.show', $Quotation_Id)}}" class="btn btn-blue mb-2">
                            <i class="fa-solid fa-right-left fa-xl"></i>&nbsp; Corregir
                        </a>
                        <a href="{{route('typestructuraljoists_caliber14.add_carrito', [$Quotation_Id,$Precio_sin_factor])}}" class="btn btn-black mb-2">
