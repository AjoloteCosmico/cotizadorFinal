    ...
    <div class="container w-full bg-white p-3 rounded-xl shadow-xl">
        <div class="row m-3">
            <div  class="row bg-white p-4 shadow-lg rounded-lg">
                {!! Form::open(['method'=>'POST', 'route' =>['double_deep_fiut_add']]) !!}
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                <div class="col-sm-12 text-right">
                                                    <a href="{{ route('quotation_installs_double_deep_show', $Quotation_Id)}}" class="btn btn-green">
                                ...
                                <div class="form-group" id="DivUnInstall">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                <div class="col-sm-12 text-right">
                                                    <a href="{{ route('quotation_uninstalls_double_deep_show', $Quotation_Id)}}" class="btn btn-green">
                                                        <i class="fas fa-plus-circle"></i>&nbsp; Agregar
                                                    </a>
                                                </div>
                                                <div class="w-100">&nbsp;</div>
