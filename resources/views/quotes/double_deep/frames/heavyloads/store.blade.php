            ...
            <div  class="row bg-white p-4 shadow-lg rounded-lg">
                <div class="col-sm-4 col-xs-12">
                    ...
                    <div class="card-body">
                        <div class="container">
                            <div class="row">
                                <img src="{{asset('vendor/img/postes/'.$Modelo.'.png')}}" class="img-thumbnail img-fluid max-h-80 rounded mx-auto d-block" alt="">
                            </div>
                ...
                <div class="col-sm-4 col-xs-12">
                    <div class="form-group p-2 text-sm font-semibold table-responsive">
                        <table class="table">
                            ...
                            <tr>
                                <td>Tornillos Trav-Diag: {{$TornTravDiag}}</td>
                ...
                <div class="col-sm-4 col-xs-12">
                    <div class="form-group p-2 text-sm font-semibold table-responsive">
                        <table class="table">
                            ...
                            <tr>
                                <td colspan="2">Tot. Tor. Trav-Diag: {{$TotTornTravDiag}}</td>
                                <td>Tot. Tor. Placas: {{$TotTornPlacas}}</td>
                            </tr>
                            <tr class="font-bold text-right text-1xl">
                    ...
                    <div class="form-group p-2 gap-2 flex items-center">
                        <a href="{{route('double_deep_frames.show', $Quotation_Id)}}" class="btn btn-blue mb-2">
