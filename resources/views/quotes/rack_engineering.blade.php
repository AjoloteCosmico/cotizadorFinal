                            ...
                            <div class="col-xs-12 col-sm-9">
                                <div class="row">
                                    <div class="col-4 gap-1">
                                        <label><input type="radio" name="a1" @if(old('a1') == "SISTEMA SELECTIVO") checked @endif value="SISTEMA SELECTIVO" id="a1_1"> SISTEMA SELECTIVO</label><br>
                                        <label><input type="radio" name="a1" @if(old('a1') == "SIST. CARTON FLOW") checked @endif value="SIST. CARTON FLOW" id="a1_2"> SIST. CARTON FLOW</label><br>
                                        <label><input type="radio" name="a1" @if(old('a1') == "CANTILEVER") checked @endif value="CANTILEVER" id="a1_3"> CANTILEVER</label><br>
                                    </div>
                                    <div class="col-4 gap-1">
                                        <label><input type="radio" name="a1" @if(old('a1') == "SISTEMA DINAMICO") checked @endif value="SISTEMA DINAMICO" id="a1_4"> SISTEMA DINAMICO</label><br>
                                        <label><input type="radio" name="a1" @if(old('a1') == "SISTEMA PICKING") checked @endif value="SISTEMA PICKING" id="a1_5"> SISTEMA PICKING</label><br>
                                        <label><input type="radio" name="a1" @if(old('a1') == "DOBLE PROFUNDIDAD") checked @endif value="DOBLE PROFUNDIDAD" id="a1_6"> DOBLE PROFUNDIDAD</label><br>
                                    </div>
                                    <div class="col-4 gap-1">
                                        <label><input type="radio" name="a1" @if(old('a1') == "SISTEMA PUSH BACK") checked @endif value="SISTEMA PUSH BACK" id="a1_7"> SISTEMA PUSH BACK</label><br>
                                        <label><input type="radio" name="a1" @if(old('a1') == "SISTEMA DRIVE IN & THRU") checked @endif value="SISTEMA DRIVE IN & THRU" id="a1_8"> SISTEMA DRIVE IN & THRU</label><br>
                                        <label><input type="radio" name="a1" @if(old('a1') == "MINI RACK") checked @endif value="MINI RACK" id="a1_9"> MINI RACK</label><br>
                                    </div>
                                    <div class="col-4 gap-1">
                                        <label><input type="radio" name="a1" @if(old('a1') == "PASARELA") checked @endif value="PASARELA" id="a1_10"> PASARELA</label><br>
                                        <label><input type="radio" name="a1" @if(old('a1') == "SUGERIR") checked @endif value="SUGERIR" id="a1_11"> SUGERIR</label><br>
                                    </div>
                                    <div class="col-4 gap-1">
                                        <label><input type="radio" name="a1" @if(old('a1') == "ENTRE PISO") checked @endif value="ENTRE PISO" id="a1_12"> ENTRE PISO</label><br>
                                    </div>
                                    <div class="col-4 gap-1">
                                        <label><input type="radio" name="a1" @if(old('a1') == "ESTANTERÍA") checked @endif value="ESTANTERÍA" id="a1_13"> ESTANTERÍA</label><br>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-12 gap-2 inline-flex">
                                        <select class="inputjet text-sm w-full uppercase" name="a6" id="a6_1">
                                            <option @if(old('a6') == "BOLSAS") selected @endif value="BOLSAS">BOLSAS</option>
                                            <option @if(old('a6') == "ROLLOS") selected @endif value="ROLLOS">ROLLOS</option>
                                            <option @if(old('a6') == "BARRIL") selected @endif value="BARRIL">BARRIL</option>
                                            <option @if(old('a6') == "CAJAS") selected @endif value="CAJAS">CAJAS</option>
                                            <option @if(old('a6') == "TARIMAS") selected @endif value="TARIMAS">TARIMAS</option>
                                            <option @if(old('a6') == "OTROS") selected @endif value="OTROS">OTROS</option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="col-xs-12 col-sm-9">
                                <div class="form-group">
                                    <select class="inputjet text-sm w-full uppercase" name="a7" id="a7_1">
                                        <option @if(old('a7') == "SI") selected @endif value="SI">SI</option>
                                        <option @if(old('a7') == "NO") selected @endif value="NO">NO</option>
                                        <option @if(old('a7') == "SE INCLUYE EN LAS DIMENSIONES SIGUIENTES") selected @endif value="SE INCLUYE EN LAS DIMENSIONES SIGUIENTES">SE INCLUYE EN LAS DIMENSIONES SIGUIENTES</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-xs-12 col-sm-12">
                                <div class="row">
                                    <div class="col col-xs-12 text-center">
                                        ...
                                        <label><input type="radio" name="a16" @if(old('a16')=="A") checked @endif value="A" id="a16_1"></label>&nbsp;&nbsp;<br><br>
                                    </div>
                                    <div class="col col-xs-12 text-center">
                                        <img src="{{ asset('vendor/img/rack_engineering/B.png')}}" alt=""><br>
                                        <label><input type="radio" name="a16" @if(old('a16')=="B") checked @endif value="B" id="a16_2"></label>&nbsp;&nbsp;<br><br>
                                    </div>
                                    <div class="col col-xs-12 text-center">
                                        <img src="{{ asset('vendor/img/rack_engineering/C.png')}}" alt=""><br>
                                        <label><input type="radio" name="a16" @if(old('a16')=="C") checked @endif value="C" id="a16_3"></label>&nbsp;&nbsp;<br><br>
                                    </div>
                                    <div class="col col-xs-12 text-center">
                                        <img src="{{ asset('vendor/img/rack_engineering/D.png')}}" alt=""><br>
                                        <label><input type="radio" name="a16" @if(old('a16')=="D") checked @endif value="D" id="a16_4"></label>&nbsp;&nbsp;<br><br>
                                    </div>
                                    <div class="col col-xs-12 text-center">
                                        <img src="{{ asset('vendor/img/rack_engineering/E.png')}}" alt=""><br>
                                        <label><input type="radio" name="a16" @if(old('a16')=="E") checked @endif value="E" id="a16_5"></label>&nbsp;&nbsp;<br><br>
                                    </div>
                                    <div class="col col-xs-12 text-center">
                                        <img src="{{ asset('vendor/img/rack_engineering/F.png')}}" alt=""><br>
                                        <label><input type="radio" name="a16" @if(old('a16')=="F") checked @endif value="F" id="a16_6"></label>&nbsp;&nbsp;<br><br>
                                    </div>
                                    <div class="col col-xs-12 text-center">
                                        <img src="{{ asset('vendor/img/rack_engineering/G.png')}}" alt=""><br>
                                        <label><input type="radio" name="a16" @if(old('a16')=="G") checked @endif value="G" id="a16_7"></label>&nbsp;&nbsp;<br><br>
                                    </div>
                                    <div class="col col-xs-12 text-center">
                                        <img src="{{ asset('vendor/img/rack_engineering/H.png')}}" alt=""><br>
                                        <label><input type="radio" name="a16" @if(old('a16')=="H") checked @endif value="H" id="a16_8"></label>&nbsp;&nbsp;<br><br>
                                    </div>
                                    <div class="col col-xs-12 text-center">
                                        <img src="{{ asset('vendor/img/rack_engineering/I.png')}}" alt=""><br>
                                        <label><input type="radio" name="a16" @if(old('a16')=="I") checked @endif value="I" id="a16_9"></label>&nbsp;&nbsp;<br><br>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-group">
                                                    ...
                                                    <x-jet-input type="text" name="a17" value="{{old('a17')}}" class="w-flex uppercase"/>
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-group">
                                                    ...
                                                    <x-jet-input type="text" name="a21" value="{{old('a21')}}" class="w-flex uppercase"/>
                                            ...
                                            <div class="col">
                                                <div class="form-group">
                                                    ...
                                                    <x-jet-input type="text" name="a22" value="{{old('a22')}}" class="w-flex uppercase"/>
                                            ...
                                            <div class="col">
                                                <div class="form-group">
                                                    ...
                                                    <x-jet-input type="text" name="a23" value="{{old('a23')}}" class="w-flex uppercase"/>
                                            ...
                                            <div class="col">
                                                <div class="form-group">
                                                    ...
                                                    <x-jet-input type="text" name="a24" value="{{old('a24')}}" class="w-flex uppercase"/>
                            ...
                            <div class="col-xs-12 col-sm-9">
                                <div class="form-group">
                                    <select class="inputjet text-sm w-full uppercase" name="a29" id="a29_1">
                                        <option @if(old('a29')=="SI") selected @endif value="SI">SI</option>
                                        <option @if(old('a29')=="NO") selected @endif value="NO">NO</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-9">
                                <div class="form-group">
                                    ...
                                    <x-jet-input type="text" name="a30" value="{{old('a30')}}" class="w-flex uppercase"/>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-9">
                                <div class="form-group">
                                    <x-jet-label value="FRENTE:" />
                                    <x-jet-input type="text" name="a31" value="{{old('a31')}}" class="w-flex uppercase"/>
                                    <x-jet-input-error for='a31' />
                                </div>
                                <div class="form-group">
                                    <x-jet-label value="FONDO:" />
                                    <x-jet-input type="text" name="a32" value="{{old('a32')}}" class="w-flex uppercase"/>
                            ...
                            <div class="col-xs-12 col-sm-9">
                                <div class="form-group">
                                    <select class="inputjet text-sm w-full uppercase" name="a33" id="a33_1">
                                        <option @if(old('a33')=="SI") selected @endif value="SI">SI</option>
                                        <option @if(old('a33')=="NO") selected @endif value="NO">NO</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-xs-12 col-sm-9">
                                <div class="form-group">
                                    <select class="inputjet text-sm w-full uppercase" name="a35" id="a35_1">
                                        <option @if(old('a35')=="SI") selected @endif value="SI">SI</option>
                                        <option @if(old('a35')=="NO") selected @endif value="NO">NO</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-xs-12 col-sm-9">
                                <div class="form-group">
                                    <select class="inputjet text-sm w-full uppercase" name="a36" id="a36_1">
                                        <option @if(old('a36')=="SI") selected @endif value="SI">SI</option>
                                        <option @if(old('a36')=="NO") selected @endif value="NO">NO</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-xs-12 col-sm-9">
                                <div class="form-group">
                                    <select class="inputjet text-sm w-full uppercase" name="a37" id="a37_1">
                                        <option @if(old('a37')=="SI") selected @endif value="SI">SI</option>
                                        <option @if(old('a37')=="NO") selected @endif value="NO">NO</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-xs-12 col-sm-9">
                                <div class="form-group">
                                    <select class="inputjet text-sm w-full uppercase" name="a38" id="a38_1">
                                        <option @if(old('a38')=="SI") selected @endif value="SI">SI</option>
                                        <option @if(old('a38')=="NO") selected @endif value="NO">NO</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <x-jet-input type="text" name="a39" value="{{old('a39')}}" style="width:50%;" class=" uppercase"/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <x-jet-input type="text" name="a40" value="{{old('a40')}}" style="width:50%;" class=" uppercase"/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <x-jet-input type="text" name="a41" value="{{old('a41')}}" style="width:50%;" class=" uppercase"/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <x-jet-input type="text" name="a42" value="{{old('a42')}}" style="width:50%;" class=" uppercase"/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <x-jet-input type="text" name="a43" value="{{old('a43')}}" style="width:50%;" class=" uppercase"/>
