            ...
            <div  class="row bg-white p-4 shadow-lg rounded-lg">
                ...
                <div class="col-sm-6 col-xs-12">
                    <div class="form-group p-2">
                        ...
                        <input type="number" name="rolados_amount" class="inputjet w-full text-xs uppercase" value="{{ $n_rolados }}" />
                        <x-jet-input-error for='rolados_amount' /><br>

                        <x-jet-label value="* Arriostrados Estructurales Cantidad" />
                        <input type="number" name="est_amount" class="inputjet w-full text-xs uppercase" value="{{ $n_est}}" />
