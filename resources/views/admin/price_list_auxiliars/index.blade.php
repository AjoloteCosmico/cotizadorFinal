        ...
        <div class="row p-3 m-2 rounded-lg shadow-xl bg-white">
            ...
            <div class="col-sm-12 table-responsive">
                <table class="table tableprice_list_installs table-striped text-xs">
                    ...
                    <tbody>
                        @foreach ($PriceListAuxiliars as $row)
                        <tr>
                            ...
                            <td class="w-20 text-center">
                                <div class="row">
                                    <div class="col-6 text-center w-10">
                                        @can('EDITAR AUXILIARES')
                                            <a href="{{ route('price_list_auxiliars.edit', $row->id)}}" class="btn btn-blue w-9 h-9">
                                    ...
                                    <div class="col-6 text-center w-10">
                                        ...
                                        {!! Form::open(['method'=>'DELETE','route'=>['price_list_auxiliars.destroy', $row->id], 'class'=>'DeleteReg' ]) !!}
