...
@section('content_header')
    <h1 class="font-bold"><i class="fas fa-circle-dollar-to-slot"></i>&nbsp; LISTA DE PRECIOS TORNILLERÍA</h1>
@stop
    ...
    <div class="container-flex m-1 bg-gray-300 shadow-lg rounded-lg">
        <div class="row p-3 m-2 rounded-lg shadow-xl bg-white">
            ...
            <div class="col-sm-12 table-responsive">
                <table class="table tableprice_list_screws table-striped text-xs">
                    ...
                    <tbody>
                        @foreach ($PriceListScrews as $row)
                        <tr>
                            ...
                            <td class="w-20 text-center">
                                <div class="row">
                                    ...
                                    <div class="col-6 text-center w-10">
                                        ...
                                        {!! Form::open(['method'=>'DELETE','route'=>['price_list_screws.destroy', $row->id], 'class'=>'DeleteReg' ]) !!}
...
@section('js')
<script type="text/javascript" src="{{ asset('vendor/mystylesjs/js/tablecatalogoprice_list_screws.js') }}"></script>
