...
class DoubleDeepTypeLRJoistController extends Controller
{
    public function caliber14_show($id)
    {
        ...
        return view('quotes.double_deep.joists.typelrjoists.caliber14.index', compact(
            'Joists',
            'Calibers',
            'Lengths',
            'Cambers',
    ...
    public function caliber14_calc(Request $request)
    {
        ...
        if($Cambers){
            ...
            $SJLR = DoubleDeepJoistLrs::where('quotation_id', $Quotation_Id)->first();
            if($SJLR){
                $SJLR->amount = $Amount;
            ...
            return view('quotes.double_deep.joists.typelrjoists.caliber14.store', compact(
                'Amount',
                'Weight',
                'JoistType',
                'Length',
    ...
    public function store(Request $request)
    {
        ...
        return view('quotes.double_deep.joists.typelrjoists.store', compact(
            'Amount',
            'Caliber',
            'Length',
            'Camber',
    ...
    public function show($id)
    {
        ...
        return view('quotes.double_deep.joists.typelrjoists.index', compact(
            'Joists',
            'Calibers',
            'Lengths',
            'Cambers',
