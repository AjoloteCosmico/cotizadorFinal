...
class DoubleDeepTypeBox25JoistController extends Controller
{
    public function caliber14_show($id)
    {
        ...
        return view('quotes.double_deep.joists.typebox25joists.caliber14.index', compact(
            'Joists',
            'Calibers',
            'Lengths',
            'Cambers',
    ...
    public function caliber14_calc(Request $request)
    {
        ...
        if($Cambers){
            ...
            $SJB2514 = DoubleDeepJoistBox25Caliber14::where('quotation_id', $Quotation_Id)->first();
            if($SJB2514){
                ...
                $SJB2514 = new DoubleDeepJoistBox25Caliber14();
            ...
            return view('quotes.double_deep.joists.typebox25joists.caliber14.store', compact(
                'Amount',
                'Weight',
                'JoistType',
                'Length',
    ...
    public function store(Request $request)
    {
        ...
        $SJB25 = DoubleDeepJoistBox25::where('quotation_id', $Quotation_Id)->first();
        if($SJB25){
            $SJB25->amount = $Amount;
            ...
            $SJB25 = new DoubleDeepJoistBox25();
        ...
        return view('quotes.double_deep.joists.typebox25joists.store', compact(
            'Amount',
            'Caliber',
            'Length',
            'Camber',
    ...
    public function show($id)
    {
        ...
        return view('quotes.double_deep.joists.typebox25joists.index', compact(
            'Joists',
            'Calibers',
            'Lengths',
            'Cambers',
